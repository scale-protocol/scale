...
pub const SUI_COIN_PUBLISH_TX: &str = "8TDZqWikkZa67quCPcTp5JY1cWWtribyLhMDZrttNzpb";
...
pub const SUI_SCALE_PUBLISH_TX: &str = "BMwXSz1Doyc1QYAdWBJYbeYibzLvDfmA31GudZhvgdff";
