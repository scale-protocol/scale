run:
	cargo install --path .
	RUST_LOG=debug scale -l /Users/lihua/work/lihua/blok/scale/scale/sui.log bot -b sui -d 5 -e true
debug:
	export RUST_LOG=scale::http=debug && export RUST_BACKTRACE=full && cargo run -- bot -b sui -e false -d 600 -p 8081 -t 10
config:
